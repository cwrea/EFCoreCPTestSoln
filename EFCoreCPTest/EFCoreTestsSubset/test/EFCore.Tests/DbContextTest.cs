...
namespace Microsoft.EntityFrameworkCore
{
    public partial class DbContextTest
    {
        ...
        public class ActiveAddContext : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) // CHANGED. No "internal" for Xamarin testing.
                => optionsBuilder.UseInMemoryDatabase(databaseName: "issue7119");

            protected override void OnModelCreating(ModelBuilder modelBuilder) // CHANGED. No "internal" for Xamarin testing.
            {
        ...
        private class NullShadowKeyContext : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder options) // CHANGED. No "internal" for Xamarin testing.
