...
namespace Microsoft.EntityFrameworkCore
{
    ...
    {
        private readonly DbFunctions _functions =
            (DbFunctions)Activator.CreateInstance(typeof(DbFunctions), nonPublic: true); // CHANGED: WAS inaccessible: new DbFunctions();
