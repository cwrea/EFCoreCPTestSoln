...
namespace Microsoft.EntityFrameworkCore.ModelBuilding
{
    public class ModelBuilderGenericTest : ModelBuilderTest
    {
        ...
        /* CHANGED: XAMARIN BUG: Including GiantModel causes a fatal build error: Xamarin.iOS.Common.targets(964,3): error : Tool exited with code: 132.
           The GiantModel.tt and GiantModel.cs files have been excluded from this project, for now.
        [Fact]
