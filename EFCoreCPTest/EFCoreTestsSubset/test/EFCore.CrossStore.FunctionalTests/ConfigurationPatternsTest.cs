...
{
    // CHANGED for Xamarin testing: WAS: [SqlServerConfiguredCondition]
    public class ConfigurationPatternsTest
    {
        ...
        public void Can_register_multiple_context_types()
        {
            ...
            using (SqliteTestStore.GetNorthwindStore()) // CHANGED for Xamarin testing: WAS: SqlServerTestStore
            {
        ...
        private class MultipleContext1 : NorthwindContextBase
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
            {
                ...
                optionsBuilder.UseSqlite(SqliteTestStore.CreateConnectionString("Northwind")); // CHANGED for Xamarin testing: WAS: UseSqlServer(...etc...)
        ...
        public class NestedContextDifferentStores
        {
            ...
            public async Task Can_use_one_context_nested_inside_another_of_a_different_type()
            {
                using (SqliteTestStore.GetNorthwindStore()) // CHANGED for Xamarin testing: WAS: SqlServerTestStore
                {
                    ...
                    var sqlServerServiceProvider = new ServiceCollection()
                        .AddEntityFrameworkSqlite() // CHANGED for Xamarin testing: WAS: AddEntityFrameworkSqlServer
                        .BuildServiceProvider();
            ...
            private class NorthwindContext : NorthwindContextBase
            {
                ...
                protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                    => optionsBuilder
                        .UseSqlite(SqliteTestStore.CreateConnectionString("Northwind")) // CHANGED for Xamarin testing: WAS: .UseSqlServer(SqlServerTestStore.NorthwindConnectionString, b => b.ApplyConfiguration())
                        .UseInternalServiceProvider(_serviceProvider);
            }
        }
    }
